...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MT3Config__ = __webpack_require__(2);
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(init);
...
function init() {
  ...
  metaBoard = new __WEBPACK_IMPORTED_MODULE_2__MT3Board__["a" /* default */]();
  metaBoard.wins = new __WEBPACK_IMPORTED_MODULE_2__MT3Board__["a" /* default */]();
  metaBoard.ended = false;
  metaBoard.lastBoard = null;
  metaBoard.lastRowIdx = null;
  metaBoard.lastColIdx = null;
  metaBoard.turn = 1;
  metaBoard.zoom = __WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].zoomDef;
  metaBoard.element(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.metaBoard)).empty();

  /* Create new DIVs and board objects for each mini board,
   *  and add them to the meta board element */
  for (ri = 0; ri < 3; ri++) {
    $mbRow = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div>').addClass('mb-row');
    for (ci = 0; ci < 3; ci++) {
      tttBoard = new __WEBPACK_IMPORTED_MODULE_2__MT3Board__["a" /* default */]();
  ...
  metaBoard.element()
    .hide()
    .fadeIn(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].fadeInTime);
  updateControls();
}

function bindEvents() {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.metaBoard).on('click', '.col', handlePlayerTurn);
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.startOver).on('click', handleStartOver);
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.undoMove).on('click', handleUndoMove);
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.zoomIn).on('click', handleZoom);
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.zoomOut).on('click', handleZoom);
...
function handlePlayerTurn() {
  ...
  colIdx = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).data('col');
  rowIdx = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().data('row');
  mbRow = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).closest(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.board).data('mbRow');
  mbCol = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).closest(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.board).data('mbCol');
...
function handleZoom() {
  ...
  zIdx = metaBoard.zoom;
  mode = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('id');
  if (mode === 'zoom-in') {
    zIdx--;
  ...
  zIdx = Math.min(zIdx, __WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].zoom.length - 1);
  metaBoard.zoom = zIdx;

  scale = __WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].zoom[zIdx].scale;
  metaBoard.element().css({
    transform: 'scale(' + scale + ') ' +
    'translate(0px, ' + __WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].zoom[zIdx].offset + ')'
  });
}
...
function updateControls() {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.turn).removeClass().addClass(player);
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.turnPlayer).text(player);
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.undoMove).attr('disabled', (metaBoard.turn === 1));
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.startOver).attr('disabled', (metaBoard.turn === 1));
}

function updateMetaBoard() {
  var nextBoard = metaBoard.lastRowIdx + '-' + metaBoard.lastColIdx;
  if (!__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.board-' + nextBoard).hasClass('won')) {
    // only enable the next clickable mini board
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.metaBoard).find(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.board).removeClass('inactive')
...
function gameOver(winner) {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(metaBoard.element()).find(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.board).removeClass('inactive')
  ...
  // disable undo button
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1__MT3Config__["a" /* default */].sels.undoMove).prop('disabled', true);
}
...
function buildBoard(mbRow, mbCol) {
  ...
  element = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div>').addClass('board board-' + mbRow + '-' + mbCol)
    .data('mbRow', mbRow)
    .data('mbCol', mbCol);
  ...
  for (ri = 0; ri < 3; ri++) {
    $rowDiv = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div>').data('row', ri)
      .addClass('row row-' + ri);
    for (ci = 0; ci < 3; ci++) {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<span>').data('col', ci)
        .addClass('col col-' + ci)
        .appendTo($rowDiv);
    }
...
function updateBoard() {
  ...
  for (ri = 0; ri < 3; ri++) {
    for (ci = 0; ci < 3; ci++) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.element()).find('.row-' + ri + ' .col-' + ci)
        .removeClass('X O')
        .text(mark)
        .addClass(mark);
    }
...
/* harmony default export */ __webpack_exports__["a"] = (TTTBoard);
